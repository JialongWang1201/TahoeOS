...
extern lv_obj_t * ui_MenuHealthPanel;
extern lv_obj_t * ui_MenuHealthButton;
extern lv_obj_t * ui_MenuHealthicon;
extern lv_obj_t * ui_MenuHealthLabel;

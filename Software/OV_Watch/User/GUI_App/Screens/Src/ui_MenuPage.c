...
lv_obj_t * ui_MenuHealthPanel;
lv_obj_t * ui_MenuHealthButton;
lv_obj_t * ui_MenuHealthicon;
lv_obj_t * ui_MenuHealthLabel;
...
void ui_event_MenuHealthPanel(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED)
...
void ui_MenuPage_screen_init(void)
{
    ...
    ui_MenuHealthPanel = lv_obj_create(ui_MenuPage);
    lv_obj_set_width(ui_MenuHealthPanel, 240);
    lv_obj_set_height(ui_MenuHealthPanel, 70);
    lv_obj_set_x(ui_MenuHealthPanel, 0);
    lv_obj_set_y(ui_MenuHealthPanel, 840);
    lv_obj_set_align(ui_MenuHealthPanel, LV_ALIGN_TOP_MID);
    lv_obj_clear_flag(ui_MenuHealthPanel, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_radius(ui_MenuHealthPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_MenuHealthPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_MenuHealthPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_MenuHealthPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_MenuHealthPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_MenuHealthPanel, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui_MenuHealthPanel, 100, LV_PART_MAIN | LV_STATE_PRESSED);

    ui_MenuHealthButton = lv_btn_create(ui_MenuHealthPanel);
    lv_obj_set_width(ui_MenuHealthButton, 40);
    lv_obj_set_height(ui_MenuHealthButton, 40);
    lv_obj_set_align(ui_MenuHealthButton, LV_ALIGN_LEFT_MID);
    lv_obj_add_flag(ui_MenuHealthButton, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_clear_flag(ui_MenuHealthButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_radius(ui_MenuHealthButton, 40, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_MenuHealthButton, lv_color_hex(0x18A999), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_MenuHealthButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MenuHealthicon = lv_label_create(ui_MenuHealthButton);
    lv_obj_set_width(ui_MenuHealthicon, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_MenuHealthicon, LV_SIZE_CONTENT);
    lv_obj_set_align(ui_MenuHealthicon, LV_ALIGN_CENTER);
    lv_label_set_text(ui_MenuHealthicon, "7D");
    lv_obj_set_style_text_font(ui_MenuHealthicon, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui_MenuHealthicon, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MenuHealthLabel = lv_label_create(ui_MenuHealthPanel);
    lv_obj_set_width(ui_MenuHealthLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_MenuHealthLabel, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_MenuHealthLabel, 60);
    lv_obj_set_y(ui_MenuHealthLabel, 0);
    lv_obj_set_align(ui_MenuHealthLabel, LV_ALIGN_LEFT_MID);
    lv_label_set_text(ui_MenuHealthLabel, "Health");
    lv_obj_set_style_text_font(ui_MenuHealthLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_event_cb(ui_MenuHealthPanel, ui_event_MenuHealthPanel, LV_EVENT_ALL, NULL);

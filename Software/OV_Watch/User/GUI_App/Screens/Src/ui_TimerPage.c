...
void ui_TimerPage_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_TimerStartLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_TimerReLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);

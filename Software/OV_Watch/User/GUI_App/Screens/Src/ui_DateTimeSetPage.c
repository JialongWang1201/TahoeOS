...
Page_t Page_AlarmSet = {ui_AlarmSetPage_screen_init, ui_AlarmSetPage_screen_deinit, &ui_AlarmSetPage};
Page_t Page_AlarmReminder = {ui_AlarmReminderPage_screen_init, ui_AlarmReminderPage_screen_deinit, &ui_AlarmReminderPage};
...
lv_obj_t * ui_AlarmSetPanel;
lv_obj_t * ui_AlarmSetLabel;
lv_obj_t * ui_AlarmValueLabel;
lv_obj_t * ui_AlarmSetPage;
lv_obj_t * ui_AlarmEnablePanel;
lv_obj_t * ui_AlarmEnableSwitch;
lv_obj_t * ui_AlarmEnableLabel;
lv_obj_t * ui_AlarmHourSetRoller;
lv_obj_t * ui_AlarmPoint;
lv_obj_t * ui_AlarmMinSetRoller;
lv_obj_t * ui_AlarmSaveButton;
lv_obj_t * ui_AlarmSaveLabel;
lv_obj_t * ui_AlarmReminderPage;
lv_obj_t * ui_AlarmReminderTitle;
lv_obj_t * ui_AlarmReminderTimeLabel;
lv_obj_t * ui_AlarmReminderHintLabel;
lv_obj_t * ui_AlarmReminderStopButton;
lv_obj_t * ui_AlarmReminderStopLabel;
...
///////////////////// FUNCTIONS ////////////////////
static void ui_alarm_summary_refresh(lv_obj_t *label)
{
    char alarm_text[20];
    ...
    {
        snprintf(alarm_text, sizeof(alarm_text), "On %02u:%02u", g_app_data.alarm_hour, g_app_data.alarm_minute);
    }
    else
    {
    ...
    lv_label_set_text(label, alarm_text);
}

static void ui_alarm_apply_setting(void)
{
    if(g_app_data.alarm_enabled)
    {
        HWInterface.RealTimeClock.SetDailyAlarm(g_app_data.alarm_hour, g_app_data.alarm_minute);
    }
    else
    {
        HWInterface.RealTimeClock.DisableAlarm();
    }
}
...
void ui_event_AlarmSetPanel(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if(event_code == LV_EVENT_CLICKED)
    {
      Page_Load(&Page_AlarmSet);
    }
}
...
void ui_event_AlarmSaveButton(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if(event_code == LV_EVENT_CLICKED)
    {
        g_app_data.alarm_enabled = lv_obj_has_state(ui_AlarmEnableSwitch,LV_STATE_CHECKED) ? 1u : 0u;
        g_app_data.alarm_hour = lv_roller_get_selected(ui_AlarmHourSetRoller);
        g_app_data.alarm_minute = lv_roller_get_selected(ui_AlarmMinSetRoller);
        ui_alarm_apply_setting();
        User_RequestDataSave();
        Page_Back();
    }
}

void ui_event_AlarmReminderStopButton(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if(event_code == LV_EVENT_CLICKED)
    {
...
void ui_DateTimeSetPage_screen_init(void)
{
    ...
    lv_obj_set_scroll_dir(ui_DateTimeSetPage, LV_DIR_VER);
    lv_obj_set_scrollbar_mode(ui_DateTimeSetPage, LV_SCROLLBAR_MODE_OFF);
    ...
    lv_obj_set_height(ui_AlarmSetPanel, 70);
    lv_obj_set_x(ui_AlarmSetPanel, 0);
    lv_obj_set_y(ui_AlarmSetPanel, 210);
    lv_obj_set_align(ui_AlarmSetPanel, LV_ALIGN_TOP_MID);
    lv_obj_clear_flag(ui_AlarmSetPanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_AlarmSetPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmSetPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmSetPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_AlarmSetPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmSetPanel, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui_AlarmSetPanel, 128, LV_PART_MAIN | LV_STATE_PRESSED);

    ui_AlarmSetLabel = lv_label_create(ui_AlarmSetPanel);
    lv_obj_set_width(ui_AlarmSetLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_AlarmSetLabel, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_height(ui_AlarmValueLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_AlarmValueLabel, -20);
    lv_obj_set_y(ui_AlarmValueLabel, 0);
    lv_obj_set_align(ui_AlarmValueLabel, LV_ALIGN_RIGHT_MID);
    lv_obj_set_style_text_font(ui_AlarmValueLabel, &ui_font_Cuyuan18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ui_alarm_summary_refresh(ui_AlarmValueLabel);
        ...
        lv_obj_add_event_cb(ui_AlarmSetPanel, ui_event_AlarmSetPanel, LV_EVENT_ALL, NULL);
...
{
    ui_AlarmSetPage = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_AlarmSetPage, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_AlarmEnablePanel = lv_obj_create(ui_AlarmSetPage);
    lv_obj_set_width(ui_AlarmEnablePanel, 240);
    lv_obj_set_height(ui_AlarmEnablePanel, 56);
    lv_obj_set_align(ui_AlarmEnablePanel, LV_ALIGN_TOP_MID);
    lv_obj_clear_flag(ui_AlarmEnablePanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_AlarmEnablePanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmEnablePanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmEnablePanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_AlarmEnablePanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_AlarmEnableLabel = lv_label_create(ui_AlarmEnablePanel);
    ...
    lv_obj_set_align(ui_AlarmEnableSwitch, LV_ALIGN_RIGHT_MID);
    if(g_app_data.alarm_enabled)
    {
        lv_obj_add_state(ui_AlarmEnableSwitch, LV_STATE_CHECKED);
    }

    ui_AlarmHourSetRoller = lv_roller_create(ui_AlarmSetPage);
    lv_roller_set_options(ui_AlarmHourSetRoller, houroptions, LV_ROLLER_MODE_NORMAL);
    lv_roller_set_selected(ui_AlarmHourSetRoller, g_app_data.alarm_hour, LV_ANIM_OFF);
    lv_obj_set_height(ui_AlarmHourSetRoller, 120);
    lv_obj_set_width(ui_AlarmHourSetRoller, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_AlarmHourSetRoller, 28);
    lv_obj_set_y(ui_AlarmHourSetRoller, -10);
    lv_obj_set_align(ui_AlarmHourSetRoller, LV_ALIGN_CENTER);
    lv_obj_set_style_text_color(ui_AlarmHourSetRoller, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_AlarmHourSetRoller, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_AlarmHourSetRoller, &ui_font_Cuyuan38, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui_AlarmHourSetRoller, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmHourSetRoller, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmHourSetRoller, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_AlarmHourSetRoller, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmHourSetRoller, lv_color_hex(0xFFFFFF), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmHourSetRoller, 0, LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui_AlarmHourSetRoller, lv_color_hex(0x0064FF), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui_AlarmHourSetRoller, 255, LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui_AlarmHourSetRoller, 2, LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_pad(ui_AlarmHourSetRoller, 1, LV_PART_SELECTED | LV_STATE_DEFAULT);

    ui_AlarmPoint = lv_label_create(ui_AlarmSetPage);
    lv_obj_set_align(ui_AlarmPoint, LV_ALIGN_CENTER);
    lv_obj_set_y(ui_AlarmPoint, -10);
    lv_label_set_text(ui_AlarmPoint, ":");
    lv_obj_set_style_text_font(ui_AlarmPoint, &ui_font_Cuyuan38, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_AlarmMinSetRoller = lv_roller_create(ui_AlarmSetPage);
    lv_roller_set_options(ui_AlarmMinSetRoller, minoptions, LV_ROLLER_MODE_NORMAL);
    lv_roller_set_selected(ui_AlarmMinSetRoller, g_app_data.alarm_minute, LV_ANIM_OFF);
    lv_obj_set_height(ui_AlarmMinSetRoller, 120);
    lv_obj_set_width(ui_AlarmMinSetRoller, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_AlarmMinSetRoller, -28);
    lv_obj_set_y(ui_AlarmMinSetRoller, -10);
    lv_obj_set_align(ui_AlarmMinSetRoller, LV_ALIGN_CENTER);
    lv_obj_set_style_text_color(ui_AlarmMinSetRoller, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_AlarmMinSetRoller, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_AlarmMinSetRoller, &ui_font_Cuyuan38, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui_AlarmMinSetRoller, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmMinSetRoller, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmMinSetRoller, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_AlarmMinSetRoller, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmMinSetRoller, lv_color_hex(0xFFFFFF), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmMinSetRoller, 0, LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui_AlarmMinSetRoller, lv_color_hex(0x0064FF), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui_AlarmMinSetRoller, 255, LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui_AlarmMinSetRoller, 2, LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_pad(ui_AlarmMinSetRoller, 1, LV_PART_SELECTED | LV_STATE_DEFAULT);

    ui_AlarmSaveButton = lv_btn_create(ui_AlarmSetPage);
    lv_obj_set_width(ui_AlarmSaveButton, 240);
    lv_obj_set_height(ui_AlarmSaveButton, 50);
    lv_obj_set_align(ui_AlarmSaveButton, LV_ALIGN_BOTTOM_MID);
    lv_obj_clear_flag(ui_AlarmSaveButton, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_radius(ui_AlarmSaveButton, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_AlarmSaveButton, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmSaveButton, 128, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui_AlarmSaveButton, 0, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_color(ui_AlarmSaveButton, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui_AlarmSaveButton, 128, LV_PART_MAIN | LV_STATE_PRESSED);
...
{
    char alarm_time_text[8];

    ui_AlarmReminderPage = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_AlarmReminderPage, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_AlarmReminderPage, lv_color_hex(0x0C1220), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmReminderPage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_AlarmReminderTitle = lv_label_create(ui_AlarmReminderPage);
    ...
    ui_AlarmReminderTimeLabel = lv_label_create(ui_AlarmReminderPage);
    lv_obj_set_align(ui_AlarmReminderTimeLabel, LV_ALIGN_CENTER);
    lv_obj_set_y(ui_AlarmReminderTimeLabel, -20);
    lv_label_set_text(ui_AlarmReminderTimeLabel, alarm_time_text);
    lv_obj_set_style_text_font(ui_AlarmReminderTimeLabel, &ui_font_Cuyuan38, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui_AlarmReminderTimeLabel, lv_color_hex(0xFFE082), LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_AlarmReminderHintLabel = lv_label_create(ui_AlarmReminderPage);
    ...
    lv_obj_set_width(ui_AlarmReminderStopButton, 180);
    lv_obj_set_height(ui_AlarmReminderStopButton, 46);
    lv_obj_set_align(ui_AlarmReminderStopButton, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(ui_AlarmReminderStopButton, -24);
    lv_obj_clear_flag(ui_AlarmReminderStopButton, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(ui_AlarmReminderStopButton, lv_color_hex(0xFF6B35), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_AlarmReminderStopButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_AlarmReminderTrigger(void)
{
    ...
    if(now_page != NULL && now_page->page_obj == &ui_AlarmReminderPage)
    {
        return;
    }

    Page_Load(&Page_AlarmReminder);
}
...
uint8_t ui_AlarmReminderIsActive(void)
{
    ...
    return now_page->page_obj == &ui_AlarmReminderPage;
}

...
static uint8_t ui_find_time_index(const uint8_t *options, uint8_t length, uint8_t value)
{
    uint8_t i = 0;
...
{
    ui_LTimeSelected = ui_find_time_index(ui_LTimeOptions, 6, ui_LTimeValue);
...
{
    ui_TTimeSelected = ui_find_time_index(ui_TTimeOptions, 6, ui_TTimeValue);

...
typedef struct
{
    ...
    void (*SetDailyAlarm)(uint8_t hours, uint8_t minutes);
...
typedef enum
{
  HW_SPO2_STATE_IDLE = 0,
  HW_SPO2_STATE_MEASURING,
  HW_SPO2_STATE_SIGNAL_WEAK,
  HW_SPO2_STATE_UNCALIBRATED,
  HW_SPO2_STATE_READY
} HW_SPO2_StateTypeDef;

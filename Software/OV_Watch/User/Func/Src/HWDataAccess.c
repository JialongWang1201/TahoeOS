...
/**************************************************************************/
/*!
    @brief  to set a daily RTC alarm

    @param  hours    alarm hour
    @param  minutes  alarm minute

	@return None
*/
/**************************************************************************/
void HW_RTC_Set_DailyAlarm(uint8_t hours, uint8_t minutes)
{
	#if HW_USE_RTC
		RTC_SetDailyAlarm(hours, minutes);
	#endif
}

/**************************************************************************/
/*!
    @brief  to disable the RTC alarm
...
*/
/**************************************************************************/
void HW_RTC_Disable_Alarm(void)
{
	#if HW_USE_RTC
		RTC_DisableAlarm();
	#endif
...
HW_InterfaceTypeDef HWInterface = {
    .RealTimeClock = {
        ...
        .SetDailyAlarm = HW_RTC_Set_DailyAlarm,
        .DisableAlarm = HW_RTC_Disable_Alarm,
